...
if(qt4)
  ...
  if(NOT QT4_FOUND)
    if(fail-on-missing)
      message(FATAL_ERROR "Qt4 package not found and qt/qtgsi/qtgui component required")
    else()
      message(STATUS "Qt4 not found. Switching off qt/qtgsi/qtgui option")
      set(qt4 OFF CACHE BOOL "" FORCE)
      set(qtgsi OFF CACHE BOOL "" FORCE)
	  set(qtgui OFF CACHE BOOL "" FORCE)
    endif()
  else()
...
if(qt5)
  ...
  if(NOT Qt5Widgets_FOUND)
    if(fail-on-missing)
      message(FATAL_ERROR "Qt5 package not found and qt/qtgsi/qtgui component required")
    else()
      message(STATUS "Qt5 not found. Switching off qt/qtgsi/qtgui option")
      set(qt OFF CACHE BOOL "" FORCE)
      set(qtgsi OFF CACHE BOOL "" FORCE)
	  set(qtgui OFF CACHE BOOL "" FORCE)
    endif()
  else()
	MATH(EXPR QT_VERSION_NUM Qt5Widgets_VERSION_STRING)
  endif()
endif()
